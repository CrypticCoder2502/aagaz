...
$mail->setFrom('flick9102@gmail.com', 'HBTU AAGAZ-19');
$mail->addAddress($email, 'Joe User');     // Add a recipient

    // Optional name
$mail->isHTML(true);                                  // Set email format to HTML

$mail->Subject = 'HBTU AAGAZ-19';
$mail->Body    = 'Welcome to HBTU AAGAZ-19. Kindly login with given Username and password<br><br><br>'.'Username :   '.$unique . '<br>Password :   '.$pwd;
